...
public class SpreadEpidemic {
    ...
    public void spread() throws IOException {
        ...
        List<String> lines = Files.readAllLines(Paths.get("src/edu/nyu/cs9053/homework6/Population.java"), Charset.defaultCharset());
        ...
        try (FileWriter writer = new FileWriter("src/edu/nyu/cs9053/homework6/Population.java", false)) {
